...
const StackedPercentageColumn2 = {
  chart: {
    type: "column",
    spacingBottom: 30,
    spacingTop: 30,
      ...
      <>
        <div ref={this.mapContainer} className="map-container">
          ...
          <div className="charts">
            <div className="chart" id="StackedPercentageColumn1">
              <HighchartsReact
                highcharts={Highcharts}
                options={StackedPercentageColumn1}
              />
            </div>
            <div className="chart ScatterPlot">
              <HighchartsReact highcharts={Highcharts} options={ScatterPlot} />
            </div>

            <div className="chart StackedPercentageColumn2">
              <HighchartsReact
                highcharts={Highcharts}
                options={StackedPercentageColumn2}
              />
            </div>
